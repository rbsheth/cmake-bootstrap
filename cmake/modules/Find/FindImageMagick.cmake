...
# Helper functions
#---------------------------------------------------------------------
function(ADD_DEBUG_LIBRARY component)
  string(REGEX MATCH ".*_RL_.*" RL_MATCHED ${ImageMagick_${component}_LIBRARY})
  if(RL_MATCHED)
    set(ImageMagick_${component}_LIBRARY_RELEASE ${ImageMagick_${component}_LIBRARY})
    string(REGEX REPLACE "(.*)_RL_(.*)" "\\1_DB_\\2" ImageMagick_${component}_LIBRARY_DEBUG ${ImageMagick_${component}_LIBRARY})
	set(ImageMagick_${component}_LIBRARY "optimized\;${ImageMagick_${component}_LIBRARY_RELEASE}\;debug\;${ImageMagick_${component}_LIBRARY_DEBUG}" PARENT_SCOPE)
  endif()
endfunction()
...
function(FIND_IMAGEMAGICK_API component header)
  ...
  find_path(ImageMagick_${component}_INCLUDE_DIR
    ...
    PATH_SUFFIXES
      ImageMagick-7 ImageMagick ImageMagick-6
  ...
  if(ImageMagick_${component}_INCLUDE_DIR AND ImageMagick_${component}_LIBRARY)
    ...
    # Add debug libraries for Windows
    ADD_DEBUG_LIBRARY(${component})
...
foreach(component ${ImageMagick_FIND_COMPONENTS}
  ...
  if(component STREQUAL "Magick++")
    FIND_IMAGEMAGICK_API(Magick++ Magick++.h
      Magick++-7.Q16 Magick++-7.Q8 Magick++-7.Q16HDRI Magick++-7.Q8HDRI Magick++ CORE_RL_Magick++_ Magick++-6.Q16 Magick++-Q16 Magick++-6.Q8 Magick++-Q8 Magick++-6.Q16HDRI Magick++-Q16HDRI Magick++-6.Q8HDRI Magick++-Q8HDRI
      )
    list(APPEND ImageMagick_REQUIRED_VARS ImageMagick_Magick++_LIBRARY)
  elseif(component STREQUAL "MagickWand")
    FIND_IMAGEMAGICK_API(MagickWand wand/MagickWand.h
      MagickWand-7.Q16 MagickWand-7.Q8 MagickWand-7.Q16HDRI MagickWand-7.Q8HDRI Wand MagickWand CORE_RL_wand_ MagickWand-6.Q16 MagickWand-Q16 MagickWand-6.Q8 MagickWand-Q8 MagickWand-6.Q16HDRI MagickWand-Q16HDRI MagickWand-6.Q8HDRI MagickWand-Q8HDRI
      )
    list(APPEND ImageMagick_REQUIRED_VARS ImageMagick_MagickWand_LIBRARY)
  elseif(component STREQUAL "MagickCore")
    FIND_IMAGEMAGICK_API(MagickCore magick/MagickCore.h
      MagickCore-7.Q16 MagickCore-7.Q8 MagickCore-7.Q16HDRI MagickCore-7.Q8HDRI Magick MagickCore CORE_RL_magick_ MagickCore-6.Q16 MagickCore-Q16 MagickCore-6.Q8 MagickCore-Q8 MagickCore-6.Q16HDRI MagickCore-Q16HDRI MagickCore-6.Q8HDRI MagickCore-Q8HDRI
      )
