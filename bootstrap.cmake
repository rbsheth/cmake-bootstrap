...
set(BOOTSTRAP_ROOT_DIR ${CMAKE_CURRENT_LIST_DIR})
...
if(NOT OPT_ARCH_FLAGS)
  OptimizeForArchitecture()
  set(ARCH_FLAGS "")
  foreach(_flag IN LISTS Vc_ARCHITECTURE_FLAGS)
    string(STRIP "${_flag}" STRIPPED_FLAG)
    set(OPT_ARCH_FLAGS "${OPT_ARCH_FLAGS} ${STRIPPED_FLAG}")
    add_compile_options(
      "$<$<COMPILE_LANGUAGE:C>:${STRIPPED_FLAG}>"
      "$<$<COMPILE_LANGUAGE:CXX>:${STRIPPED_FLAG}>"
    )
  endforeach()
endif()
